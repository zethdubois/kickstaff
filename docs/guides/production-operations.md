...
**Audience:** Operators and admins using the **live** Kick Asset Management site — not developers editing code. For implementation details (schema, server actions, guards), see [admin-rental-links.md](admin-rental-links.md).
