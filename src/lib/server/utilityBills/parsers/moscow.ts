...
import type { ParsedUtilityBill, UtilityBillParser } from './types';
...
export class MoscowUtilityBillParser implements UtilityBillParser {
	async parse(pdfBuffer: Buffer): Promise<ParsedUtilityBill> {
